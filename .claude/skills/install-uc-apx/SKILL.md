...
Finally, confirm `uc-apx version` and report the generated paths. If this
repository provides `scripts/check_local_links.py`, run it; this team template
does not currently bundle that helper. Do not commit generated skills unless
