...
class RecordExportStateTests(unittest.TestCase):
    def run_recorder(self, before: str, after: str, timezone: str = "UTC"):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            before_path.write_text(before + "|2026-09-26T09:00:00\n", encoding="utf-8")
            after_path.write_text(after + "|2026-09-26T09:00:02\n", encoding="utf-8")
